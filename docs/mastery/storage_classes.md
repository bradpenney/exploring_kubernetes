...
!!! tip "Part of Mastery: Storage and State"
    This article is part of [Mastery: Storage and State](storage_overview.md). Complete [Persistent Volume Claims (PVC)](persistent_volume_claims.md) first if you haven't already.
