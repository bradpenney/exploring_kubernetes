...
!!! tip "Part of Mastery: Scheduling & Security"
    This is the third article in [Mastery: Scheduling & Security](security_overview.md). Make sure you understand [Taints and Tolerations](taints_tolerations.md) first.
