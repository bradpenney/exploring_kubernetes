...
!!! tip "Part of Mastery: Scheduling & Security"
    This is the first article in [Mastery: Scheduling & Security](security_overview.md). Master resource management before moving to node scheduling.
...
-   :material-chart-timeline-variant: **Monitor Resource Usage**
    ...
    **Tools:** Prometheus + Grafana (covered in Production Operations).
