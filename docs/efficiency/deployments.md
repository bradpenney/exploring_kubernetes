...
!!! tip "Part of Efficiency: Workloads"
    This article is part of [Efficiency: Workloads](workloads_overview.md). Make sure you understand [Pods](../essentials/pods.md) and [Services](../essentials/services.md) first.
...
We'll cover autoscaling in detail in Scheduling & Security.
...
- [Pods: The Atomic Unit](../essentials/pods.md) - What Deployments manage
