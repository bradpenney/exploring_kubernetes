...
The Workloads section teaches **workload controllers**—the Kubernetes resources that manage pods for you:
...
Efficiency marks a shift in mindset:

- **Day One / Essentials:** "How do I get this working?"
- **Efficiency:** "How do I keep this working reliably?"
...
After Workloads, you'll move to **Efficiency: Networking**, where you'll dive deep into how services communicate, Ingress controllers for HTTP routing, and Network Policies for security.
